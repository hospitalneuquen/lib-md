        ...
        var dgeni = new Dgeni([require('../config/')
            .config(function(readFilesProcessor, writeFilesProcessor) {
                ...
                readFilesProcessor.sourceFiles = [{
                    include: '../js/src/global/**/*.js',
                    basePath: 'src'
                }
                , {
                    include: '../js/src/plex/directives/**/*.js',
                    basePath: 'src'
                }
                , {
                    include: '../js/src/plex/filters/**/*.js',
                    basePath: 'src'
                }
                , {
                    include: '../js/src/plex/modules/**/*.js',
                    basePath: 'src'
                }
                , {
                    include: '../js/src/plex/services/**/*.js',
                    basePath: 'src'
                }
                , {
